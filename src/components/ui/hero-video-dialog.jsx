    ...
    (<div className={cn("relative", className)}>
      <div
        ...
        <img
          ...
          width={1920}
          height={1080}
          className="w-full transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-2xl shadow-lg border border-color-1/15" />
        <div
          ...
          <div
            className="bg-neutral-900/10 flex items-center justify-center rounded-full backdrop-blur-md size-28 dark:bg-neutral-50/10">
            <div
